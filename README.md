...
- **Report**: A detailed report of the project can be found here: [Report](./Multivar_report.md)
- **Code**: An Rmarkdown file of the report with the R code be found here: [Rmarkdown Report](./Multivar_report.Rmd)
...
3. [Exploratory Data Analysis](#Exploratory-Data-Analysis)
    - [Popularity Variable Distributions](#popularity-variable-distributions)
    - [Independent Variable Distributions](#independent-variable-distributions)
